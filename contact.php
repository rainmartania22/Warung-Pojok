...
<head>
    ...
    <title>Hubungi Kami - WarungPojok</title>
                            ...
                            <ul class="addr-info">
                                ...
                                <li>
                                    <div class="if-item">
                                        ...
                                        <p class="dsc">0838-6517-7778</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Email:</b>
                                        <p class="dsc">WarungPojok@gmail.com</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Toko Buka:</b>
                                        <p class="dsc">Jam Buka: Setiap hari, Mulai pukul 08.00</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
